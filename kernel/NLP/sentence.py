...
#import W_utility.newfile as ufile
import word as NLP_word
import re, string
import porter2

# splitting text into Sentences using NLTK tokenization
def sentence_splitting (texts, slen = 1,language = "Chinese"):
	#count = 0
	if len(texts) <= 0:
		#print count
		return []
...
if __name__ == '__main__':
	fin = r"D:/TEXer\TEXer_temporal - Copy/data/timextry_TEXer.txt"
	text=ufile.read_file(fin, 1, False)
	sentence_splitting (text, 2)
	'''